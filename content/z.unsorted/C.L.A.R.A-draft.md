...
```mermaid
graph TB
    A[Player Temui CLARA] --> B{CLARA Version}
    B -->|Standard| C[Quest Rutin: <br>- Laporkan Glitch<br>- Kumpulkan Essence]
    B -->|Mysterious| D[Quest Terselubung: <br>- Hapus Bukti<br>- Sabotase Player Lain]
    B -->|Lore-Integrated| E[Quest Fragmen: <br>- Cari Rekaman Naga<br>- Pecahkan Password]
    A --> F[Password Debugger] 
    F --> G["“Dragonova_Prime_Alpha” (kode tersembunyi di dialog CLARA)"]
```
